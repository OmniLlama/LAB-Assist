...
function EditorHTML() {
  btn_Play = document.getElementById('play') as HTMLButtonElement,
    btn_Record = document.getElementById('record') as HTMLButtonElement,
    btn_Loop = document.getElementById('loop') as HTMLButtonElement,
    btn_Stop = document.getElementById('stop') as HTMLButtonElement,
    btn_Prev = document.getElementById('prev') as HTMLButtonElement,
    btn_Next = document.getElementById('next') as HTMLButtonElement,
    btn_Last = document.getElementById('last') as HTMLButtonElement,
    btn_First = document.getElementById('first') as HTMLButtonElement,
    btn_AddPart = document.getElementById('add-part') as HTMLButtonElement,
    ...
    div_Controls = document.getElementById('editor-controls') as HTMLDivElement,
    div_BarsBeats = document.getElementById('time-bars-beats') as HTMLDivElement,
    div_Seconds = document.getElementById('time-seconds') as HTMLDivElement,
    div_MouseX = document.getElementById('mouse-x') as HTMLDivElement,
    div_MouseY = document.getElementById('mouse-y') as HTMLDivElement,
    div_PageNumbers = document.getElementById('page-numbers') as HTMLDivElement,
    div_Editor = document.getElementById('editor') as HTMLDivElement,
    div_Score = document.getElementById('score') as HTMLDivElement,
    div_BarLines = document.getElementById('bar-lines') as HTMLDivElement,
    div_BeatLines = document.getElementById('tick-lines') as HTMLDivElement,
    div_SixteenthLines = document.getElementById('sub-tick-lines') as HTMLDivElement,
    div_PitchLines = document.getElementById('pitch-lines') as HTMLDivElement,
    div_Notes = document.getElementById('notes') as HTMLDivElement,
    div_Parts = document.getElementById('parts') as HTMLDivElement,
    div_Playhead = document.getElementById('playhead') as HTMLDivElement,
    slct_Snap = document.getElementById('snap') as HTMLDivElement,
    div_currNote = document.getElementById('dbg-curr-note') as HTMLDivElement,
    div_currPart = document.getElementById('dbg-curr-part') as HTMLDivElement,
...
let  btn_Play: HTMLButtonElement;
let  btn_Record: HTMLButtonElement;
let  btn_Loop: HTMLButtonElement;
let  btn_Stop: HTMLButtonElement;
let  btn_Prev: HTMLButtonElement;
let  btn_Next: HTMLButtonElement;
let  btn_Last: HTMLButtonElement;
let  btn_First: HTMLButtonElement;
let  btn_AddPart: HTMLButtonElement;

var txt_KeyRangeStart,
  txt_KeyRangeEnd,
  sldr_barsPerPage,
...
function render() {
  ...
  tmp_snapshot.notes.changed.forEach(function (note) { updateElementBBox(divs_AllNotes[note.id], note.bbox); });
  ...
  // events.changed, notes.changed, parts.changed contain elements that have been moved or transposed
  tmp_snapshot.parts.changed.forEach(function (part) { updateElementBBox(divs_AllParts[part.id], part.bbox); });
